  ...
  return (
    <header className="mx-auto flex max-w-[720px] flex-col items-center pt-10 text-center md:pt-16">
      ...
      <p className="mx-auto mt-8 max-w-[680px] text-[15px] leading-8 text-zinc-600 dark:text-zinc-300">
        I'm a software engineer focused on distributed systems and databases — Learning about fault-tolerant storage engines, consensus protocols, query processing, and high-reliability, low-latency architectures.
